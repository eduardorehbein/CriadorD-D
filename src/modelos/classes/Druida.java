...
public class Druida extends Classe implements Magica{
	...
	public void inicializa(Personagem personagem) {
		...
		personagem.idiomasAdd("Druídico");
	...
	protected void setHabilidades() {
		super.habilidadesAdd(new Habilidade("Druídico", "\tVocê conhece o Druídico, o idioma secreto dos druidas. Você pode falar esse idioma e usá-lo para deixar mensagens escondidas. Você e outros que conheçam esse idioma automaticamente veem tais mensagens. Outros perceberão a presença da mensagem se passarem num teste de Sabedoria (Percepção) CD 15, mas não conseguirão decifrá-lo sem magia.\n\n", 1));
		super.habilidadesAdd(new Habilidade("Conjuração", "\tBaseado na essência divina da própria natureza, você pode conjurar magias para moldar sua essência a sua vontade. Veja o capítulo 10 para as regras gerais de conjuração e o capítulo 11 para a lista de magias de druida.\n" + 
				"\tTruques: Você conhece dois truques, à sua escolha, da lista de magias de druida. Você aprende truques de druida adicionais, à sua escolha, em níveis mais altos, como mostrado na coluna Truques Conhecidos da tabela O Druida.\n" +
				...
				"\tPlantas e Florestas Sagradas: O druida tem certas plantas como sagradas, em particular o amieiro, freixo, bétula, elder, avelã, azevinho, zimbro, visco, carvalho, sorva, salgueiro e teixo. Druidas, muitas vezes, usam essas plantas como parte de seu foco de conjuração, incorporando lascas de carvalho ou teixo ou ramos de visco branco.\n" +
				...
				"\tFoco de Conjuração: Você pode usar um foco druídico (encontrado no capítulo 5) como foco de conjuração das suas magias de druida.\n\n", 1));
		super.habilidadesAdd(new Habilidade("Forma selvagem", "\tA partir do 2° nível, você pode usar sua ação para assumir magicamente a forma de uma besta que você já tenha visto antes. Você pode usar essa característica duas vezes. Você recupera os usos quando termina um descanso curto ou longo.\n" +
				...
				"\t2º		-	1/2		-	Sem deslocamento de voo				-	Crocodilo\n" +
				"\t2º		-	1		-	-									-	Águia gigante\n" +
		...
		super.habilidadesAdd(new Habilidade("Círculo de druídico", "\tNo 2° nível, você escolhe se identificar com um círculo de druidas: o Círculo da Terra ou o Círculo da Lua, ambos detalhados no final da descrição da classe. Sua escolha lhe concede características no 2° nível e novamente no 6°, 10° e 14° nível.\n\n", 2));
		...
		super.habilidadesAdd(new Habilidade("Corpo atemporal", "\tComeçando no 18° nível, a magia primordial que você controla faz com que você envelheça mais lentamente. Para cada 10 anos que passarem, seu corpo envelhece apenas 1.\n\n", 18));
		super.habilidadesAdd(new Habilidade("Magias da besta", "\tA partir do 18° nível, você pode conjurar muitas das suas magias em qualquer forma que assumir usando a Forma Selvagem. Você pode realizar os componentes somáticos e verbais de uma magia de druida na forma de besta, mas você não é capaz de prover os componentes materiais.\n\n", 18));
		super.habilidadesAdd(new Habilidade("Arquidruida", "\tNo 20° nível, você pode usar sua Forma Selvagem um número ilimitado de vezes.\n" +
